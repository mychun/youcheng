...
namespace RTBcms.Web.admin.settings
{
    public partial class sys_config : Web.UI.ManagePage
    {
        ...
        private void ShowInfo()
        {
            ...
            seotitle.Text = model.seotitle;
            seokeyword.Text = model.seokeyword;
            seodescription.Text = model.seodescription;
            seocopyright.Text = model.seocopyright;
            ...
            if (model.onlinecustomerservice == 1)
            {
                onlinecustomerservice.Checked = true;
            }
            else
            {
                onlinecustomerservice.Checked = false;
            }
            if (model.smsverification == 1)
            {
                smsverification.Checked = true;
            }
            else
            {
                smsverification.Checked = false;
            }
            ...
            onlineorderaddress.Text = model.onlineorderaddress;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                model.seotitle = seotitle.Text;
                model.seokeyword = seokeyword.Text;
                model.seodescription = seodescription.Text;
                model.seocopyright = seocopyright.Text;
                model.onlineorderaddress = onlineorderaddress.Text;
                ...
                if (onlinecustomerservice.Checked == true)
                {
                    model.onlinecustomerservice = 1;
                }
                else
                {
                    model.onlinecustomerservice = 0;
                }
                if (smsverification.Checked == true)
                {
                    model.smsverification = 1;
                }
                else
                {
                    model.smsverification = 0;
                }
