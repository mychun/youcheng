<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_list.aspx.cs" Inherits="RTBcms.Web.admin.manager.manager_list" %>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td><%#new RTBcms.BLL.manager_role().GetTitle(Convert.ToInt32(Eval("role_id")))%></td>
