<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="RTBcms.Web.admin.index" %>
...
<link href="../scripts/OverlayScrollbars/OverlayScrollbars.min.css" rel="stylesheet" type="text/css" />
<link href="skin/default/style.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" charset="utf-8" src="../scripts/jquery/jquery-1.11.2.min.js"></script>
<script type="text/javascript" charset="utf-8" src="../scripts/jquery/jquery.nicescroll.js"></script>
<script type="text/javascript" charset="utf-8" src="../scripts/OverlayScrollbars/OverlayScrollbars.min.js"></script>
...
<form id="form1" runat="server">
    ...
    <div class="nav-right">
      <div class="info">
        ...
        <span>
          ...
          <%=new RTBcms.BLL.manager_role().GetTitle(admin_info.role_id) %>
        </span>
      </div>
      <div class="option">
        <i></i>
  ...
  <div class="main-left">
    <div class="logo"><img style="height:42px;" src="/images/logo.png" /></div>
    <div class="scroll-lump">
