<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_audit.aspx.cs" Inherits="RTBcms.Web.admin.users.user_audit" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new RTBcms.BLL.user_groups().GetTitle(Convert.ToInt32(Eval("group_id")))%></td>
