...
namespace RTBcms.Web.Plugin.Link.DAL
{
    /// <summary>
    /// 数据访问类:link
    /// </summary>
                ...
                using (OleDbTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        OleDbParameter[] parameters = {
					            ...
					            new OleDbParameter("@user_tel", OleDbType.VarChar,20),
					            new OleDbParameter("@email", OleDbType.VarChar,50),
					            new OleDbParameter("@site_url", OleDbType.VarChar,255),
					            new OleDbParameter("@img_url", OleDbType.VarChar,255),
					            new OleDbParameter("@is_image", OleDbType.Integer,4),
