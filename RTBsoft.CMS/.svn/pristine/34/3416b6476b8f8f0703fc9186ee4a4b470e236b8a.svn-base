<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="online_service_list.aspx.cs" Inherits="RTBcms.Web.Plugin.OnlineService.admin.online_service_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="online_service_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
    <tr>
      ...
      <th align="left" width="15%">QQ号码</th>
      <th align="left" width="18%">名称</th>
      <th align="left" width="12%">添加日期</th>
  ...
  <ItemTemplate>
    <tr>
      ...
      <td><%#Eval("service_template")%></td>
      <td><%#Eval("service_title")%></td>
      ...
      <td align="center"><a href="online_service_edit.aspx?action=<%#(int)DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
