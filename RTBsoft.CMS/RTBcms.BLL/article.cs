...
namespace RTBcms.BLL
{
    ...
    public partial class article
    {
        ...
        /// 根据视图显示前几条数据
        /// </summary>
        public DataSet GetList(string channel_name, int category_id, int Top, string strWhere, string filedOrder, string product)
        {
            return dal.GetList(channel_name, category_id, Top, strWhere, filedOrder, "product");
        }
        ...
        /// 根据视图获得查询分页数据
        /// </summary>
        public DataSet GetList(string channel_name, int category_id, int pageSize, int pageIndex, string strWhere, string filedOrder, out int recordCount, string product)
        {
            return dal.GetList(channel_name, category_id, pageSize, pageIndex, strWhere, filedOrder, out recordCount, "product");
        }
        /// <summary>
        /// 根据视图获取总记录数
        /// </summary>
