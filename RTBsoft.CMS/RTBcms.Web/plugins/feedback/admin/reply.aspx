<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reply.aspx.cs" Inherits="RTBcms.Web.Plugin.Feedback.admin.reply" ValidateRequest="false" %>
...
<div id="floatHead" class="content-tab-wrap">
  <div class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a class="selected" href="javascript:;">查看预约</a></li>
      </ul>
    </div>
  </div>
</div>
...
<div class="tab-content">
  <dl>
    <dt>所属站点</dt>
    <dd><%=new RTBcms.BLL.channel_site().GetTitle(model.site_path)%></dd>
  </dl>
    <dl>
    <dt>公司名称</dt>
    <dd><%=model.title %></dd>
...
<div class="page-footer" style="display:none;">
  <div class="btn-wrap">
    <asp:Button ID="btnSubmit" runat="server" Text="回复预约" CssClass="btn" onclick="btnSubmit_Click" />
