<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="RTBcms.Web.Plugin.Feedback.admin.index" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    <th width="8%">选择</th>
    <th width="16%" align="left">公司名称</th>
     <th width="12%" align="left">姓名</th>
    <th width="12%" align="left">联系电话</th>
    <th width="16%" align="left">电子邮箱</th>
    <th width="16%" align="left">意向产品</th>
    <th width="8%">状态</th>
     <th width="110px" align="left">提交时间</th>
  </tr>
</HeaderTemplate>
<ItemTemplate>
  <tr>
    ...
    <td><a href="reply.aspx?id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
    <td><%#Eval("user_name")%></td>
      <td><%#Eval("user_tel")%></td>
      <td><%#Eval("user_email")%></td>
      <td><%#Eval("content")%></td>
    <td align="center">
      <%# Convert.ToInt32(Eval("is_lock")) == 1 ? "未审核" : "已审核"%>
    </td>
