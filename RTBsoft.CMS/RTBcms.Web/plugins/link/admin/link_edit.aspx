<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="link_edit.aspx.cs" Inherits="RTBcms.Web.Plugin.Link.admin.link_edit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <span>站点管理</span>
            <i class="arrow"></i>
            <a href="index.aspx"><span>友情链接</span></a>
            <i class="arrow"></i>
            <span>编辑链接</span>
        </div>
        ...
        <div class="tab-content">
            ...
            <dl style="display:none;">
                <dt>联系人</dt>
                <dd>
                    <asp:TextBox ID="txtUserName" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox></dd>
            </dl>
            <dl style="display:none;">
                <dt>联系电话</dt>
                <dd>
                    <asp:TextBox ID="txtUserTel" runat="server" CssClass="input normal" datatype="*0-30" sucmsg=" "></asp:TextBox></dd>
            </dl>
            <dl style="display:none;">
                <dt>电子邮箱</dt>
                <dd>
                    <asp:TextBox ID="txtEmail" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>链接网址</dt>
                <dd>
