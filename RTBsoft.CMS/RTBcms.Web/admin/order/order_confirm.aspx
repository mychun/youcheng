<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_confirm.aspx.cs" Inherits="RTBcms.Web.admin.order.order_confirm" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new RTBcms.BLL.payment().GetTitle(Convert.ToInt32(Eval("payment_id")))%></td>
    <td><%#new RTBcms.BLL.express().GetTitle(Convert.ToInt32(Eval("express_id")))%></td>
