<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_config.aspx.cs" Inherits="RTBcms.Web.admin.settings.sys_config" ValidateRequest="false" %>
...
<div class="tab-content">
  ...
  <dl>
    <dt>首页标题(SEO)</dt>
    <dd>
      <asp:TextBox ID="seotitle" runat="server" CssClass="input normal" />
    ...
    <dt>页面关健词(SEO)</dt>
    <dd>
      <asp:TextBox ID="seokeyword" runat="server" CssClass="input normal" />
  ...
  <dl>
    <dt>页面描述(SEO)</dt>
    <dd>
      <asp:TextBox ID="seodescription" runat="server" CssClass="input normal" />
  ...
  <dl>
    <dt>底部版权信息</dt>
    <dd>
      <asp:TextBox ID="seocopyright" runat="server" CssClass="input" TextMode="MultiLine" />
...
<div class="tab-content" style="display:none">
  ...
  <dl style="display:none;">
   ...
   <dl>
    <dt>在线订单地址</dt>
    <dd>
      <asp:TextBox ID="onlineorderaddress" runat="server" CssClass="input txt" datatype="*1-100" sucmsg=" " />
      <span class="Validform_checktip">*设置订单地址的链接</span>
    </dd>
  </dl>
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-checkbox">
          <asp:CheckBox ID="onlinecustomerservice" runat="server" />
      </div>
        <span class="Validform_checktip">*关闭后在线客服将会隐藏</span>
    </dd>
  </dl>
    <dl style="display:none;">
    <dt>是否开启短信验证</dt>
    <dd>
      <div class="rule-single-checkbox">
          <asp:CheckBox ID="smsverification" runat="server" />
      </div>
        <span class="Validform_checktip">*关闭后用户注册将不用短信验证</span>
    </dd>
  </dl>
  <dl>
    <dt>是否开启网站</dt>
