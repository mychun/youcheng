<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_edit.aspx.cs" Inherits="RTBcms.Web.admin.article.article_edit" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
      ...
      <asp:Label ID="div_sell_price_tip" runat="server" CssClass="Validform_checktip" />
        ...
        <div class="tab-content" style="display: none">
            ...
            <dl style="display:none;" id="div_author" runat="server" visible="false">
                <dt>
